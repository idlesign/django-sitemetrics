...
class Keycode(models.Model):
    ...
    provider = models.CharField(
        _('Provider'), max_length=50, choices=get_provider_choices(), help_text=_('Metrics service provider name.'))
    keycode = models.CharField(
        _('Keycode'), max_length=80, help_text=_('Keycode or identifier given by metrics service provider for site(s).'))
    active = models.BooleanField(
        _('Active'), default=True, help_text=_('Whether this keycode is available to use.'))
